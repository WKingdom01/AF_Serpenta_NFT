...
export const statusHelper = (statusCode) => {
  switch (statusCode) {
    ...
    case 2:
      return {status:'waitlist',alert:'You are in the Waitlist : This starts at Wednesday, August 17, 2022 11:00 PM',time:new Date('2022', '7', '17', '00', '00', '00', '00')};
    default:
      return {status:'public',alert:'This wallet has not been found in our white or wait list.\
       The public mint starts at Thursday, August 18, 2022 1:00 AM',time:new Date('2022', '7', '17', '00', '00', '00', '00')};
  }
};
111