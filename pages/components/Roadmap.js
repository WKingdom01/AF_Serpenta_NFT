...
const Roadmap = () => {
  ...
  function stageOne(stage, index) {
    ...
    if (window.innerWidth >= 992) {
      ...
      tl.to(
        stage.selector + ' .stage-text__header',
        1,
        { text: stage.text },
        '-=1'
      );
      tl.fromTo(
        stage.selector + ' .stage__image',
        7,
        { y: 0 },
  ...
  useEffect(() => {
    ...
    const stages = [
      ...
      { selector: '.stage--three', text: t('roadmap.stageThree.header') },
  ...
  return (
    <section className="roadmap">
      <h2 className="roadmap__title title">{t('roadmap.title')}</h2>
