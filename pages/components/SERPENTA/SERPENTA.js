        ...
        <div className = {styles.row2}>
            <div className = {styles.columnLeft}>
                ...
                <div className = {styles.drgExplainTxt}>
                    <p>This dragon is generating keys! Use them to open the lootboxes & win rewards. The key will generate in:</p>
            ...
            <div className = {styles.columnRight}>                  
                <div className = {styles.columnRight}>
                    ...
                    <div className = {styles.timeline}> 
                        <div className={styles.passline} style={{width:'30%'}}>
                        </div>
                    </div>
                </div>         
                ...
                <div className = {styles.revealImgArray}>
                    ...
                    <div>
                        ...
                        <div className = {styles.artefactImg}>
                            <div className = {styles.artefactN}>
                                <Image src = {Artefactunreveal}></Image>
                            </div>
                        </div>
                    </div>
                    <div >
                        <div className = {styles.revealImg}>
                            <Image src = {unreveal1}></Image>
                        </div>
